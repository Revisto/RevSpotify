...
class Spotify(object):
    ...
    def artist_top_tracks(self, artist_id, country="US"):
        ...
        artist_data = self._get("artists/" + trid, country=country)
        results["artist"] = dict() 
        results["artist"]["genres"] = artist_data["genres"]
        results["artist"]["images"] = artist_data["images"]
        results["artist"]["name"] = artist_data["name"]
        return results
